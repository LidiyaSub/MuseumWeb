...
<body>
	...
	<div class="container">
		<h2>Create new showpiece</h2>
		<form action="createShowpiece" method="POST" class="form-horizontal">
			<div class="form-group">
				<label for="name" class="col-sm-2 control-label">Name
					Showpiece</label>
				<div class="col-sm-10">
					<input type="text" name="nameShowpiece" class="form-control" /> <br>
				</div>
			</div>
			<div class="form-group">
				<label for="name" class="col-sm-2 control-label">Date Income</label>
				<div class="col-sm-10">
					<input type="text" name="dateIncome" id="datetimepicker"
						class="form-control" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" name="technics" class="form-control" />
				</div>
			</div>
			<div class="form-group">
				<label for="name" class="col-sm-2 control-label">Hall</label>
				<div class="col-sm-5">
					<select name="hallId" size="5" id="list_Schedules"
						class="form-control">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<select name="authorId" size="5" id="list_Schedules"
						class="form-control">
						<option value="0" label="--Select hall--" />
