...
VALUES ('Shine on You Crazy Diamond', '2015-01-01', 'Oil', 'New', 1, 1), 
	('Another Brick in the Wall', '2015-02-02', 'Paint', 'Old School', 2, 2),
	('Welcome to Machine','2015-03-03', 'Fabric', 'Old Fashioned', 3, 3),
    ('Cluster One', '2015-04-04', 'Plastiline', 'Post modern', 3, 1),
    ('Time', '2015-05-05', 'Pensil', 'Neo Classic', 1, 1),
	('Money', '2015-06-06', 'Pen', 'Barrocco', 1, 3),
    ('Comfortumbly Numb', '2015-07-07', 'Ink bow', 'Avantgarde', 1, 2),
    ('Marooned', '2015-09-09', 'Oil', 'Neo Classic', 3, 2),
    ('Endless River', '2015-10-10', 'Paint', 'Post Modern', 2, 2),
    ('Have a Cigar', '2015-11-11', 'Brush', 'New School', 1, 2);